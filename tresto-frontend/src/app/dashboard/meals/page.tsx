...
import { deleteMealAction, getMealsAction, updateMealAction } from "./actions";
...
export default function MealsPage() {
    ...
    async function onConfirmDelete() {
        ...
        await deleteMealAction(deletingMealId);

        setIsDeleteOpen(false);
        setMeals((prevMeals) => prevMeals?.filter((meal) => meal.id != deletingMealId));
    } 
        ...
        <>
                    ...
                    <DialogContent>
                        ...
                        <form onSubmit={handleCreateCategory} className="space-y-4">
                            <input
                                ...
                                className="h-11 w-full rounded-lg border bg-background px-3 outline-none focus:border-primary text-sm"
                                autoFocus
                            />
            ...
            <Dialog open={isEditOpen} onOpenChange={setIsEditOpen}>
                <DialogContent className="sm:max-w-106.25">
                    <DialogHeader>
                        <DialogTitle>تعديل الوجبة</DialogTitle>
                    </DialogHeader>

                    {editingMeal && (
                        <form onSubmit={onSaveEdit} className="space-y-4">
                            <div>
                                <label className="text-sm font-medium block mb-1">اسم الوجبة</label>
                                <input
                                    type="text"
            ...
            <Dialog open={isDeleteOpen} onOpenChange={setIsDeleteOpen}>
                <DialogContent className="sm:max-w-100">
                    ...
                    <p className="text-sm text-muted-foreground my-2">
                        هل أنت تأكد من أنك تريد حذف هذه الوجبة؟ لا يمكن التراجع عن هذا الإجراء.
                    </p>
